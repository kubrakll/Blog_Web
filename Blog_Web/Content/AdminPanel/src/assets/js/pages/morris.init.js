...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b', 'c'], ['Activated', 'Pending', 'Deactivated'], ['#44a2d2', '#ffbb44', '#98d4ce']);
            ...
            this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#44a2d2', '#98d4ce']);
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#009688', '#fdb93e', '#148cca']);
            ...
            this.createDonutChart('morris-donut-example', $donutData, ['#44a2d2', '#98d4ce', '#e6edf3']);
